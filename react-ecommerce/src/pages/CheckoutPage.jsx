...
function CheckoutPage() {
  ...
  const [selectPaymentMethod, setSelectedPaymentMethod] = useState("cash");
  ...
  const handleOrder = () => {
    if (selectedAddress && selectPaymentMethod) {
      const order = {
        items,
        totalAmount,
        totalItems,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                    ...
                    <>
                      ...
                      <ul>
                        {user.addresses.map((address, index) => (
                          <li
                            key={index}
                            className="flex justify-between gap-x-6 px-5 py-5 my-2 border-solid border-2 border-gray-200"
                          >
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-6">
